...
```
- **Training set**:   Fairseq has provided two versions of training set: (1) 3.9M training samples and (2) 4.5M training samples. We reported the results with the 4.5M training set (the same as the original paper [transformer](https://arxiv.org/abs/1706.03762)) in this paper. Using the 3.9M training set will lead to better results. 
